        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-3">
              <a href="https://github.com/Ivandv19" target="_blank" rel="noreferrer" className="p-2 bg-accent/5 hover:bg-accent/10 rounded-lg text-text-muted hover:text-accent transition-all duration-300">
                <Github size={18} />
              </a>
              <a href="https://www.linkedin.com/in/ivan-cruz-1906mx" target="_blank" rel="noreferrer" className="p-2 bg-accent/5 hover:bg-accent/10 rounded-lg text-text-muted hover:text-accent transition-all duration-300">
                <Linkedin size={18} />
              </a>
              <a href="https://discord.com/users/ivandv19" target="_blank" rel="noreferrer" className="p-2 bg-accent/5 hover:bg-accent/10 rounded-lg text-text-muted hover:text-accent transition-all duration-300">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm font-medium">
              ...
              <li><Link to="/skills" className="hover:text-accent transition-colors">Skills</Link></li>
              <li><Link to="/experiencia" className="hover:text-accent transition-colors">Experiencia</Link></li>
          ...
          <div className="md:pt-10">
            <ul className="space-y-4 text-sm font-medium">
              <li><Link to="/sobre-mi" className="hover:text-accent transition-colors">Sobre Mí</Link></li>
              <li><Link to="/formacion" className="hover:text-accent transition-colors">Formacion</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm font-medium">
              <li><Link to="/terminos" className="hover:text-accent transition-colors">Términos y Condiciones</Link></li>
              <li><Link to="/privacidad" className="hover:text-accent transition-colors">Política de Privacidad</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="flex flex-col items-center space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <div className="flex flex-col items-center gap-4 py-4">
            <p className="text-[11px] text-text-muted opacity-60 tracking-wider">
              © {new Date().getFullYear()} Ivan Cruz. Todos los derechos reservados.
            </p>
            <img src="/CircleFlagsMx.svg" alt="México" className="h-4 w-4 opacity-80" />
          </div>
        </div>
      </div>
    </footer>
