      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16 space-y-4 mt-16">
          ...
          <div className="flex items-center justify-center gap-4">
            ...
            <p className="text-text-muted text-lg italic">Mi historia y quién soy</p>
            <div className="h-px bg-text-main flex-1 rounded-full opacity-20 max-w-[100px]"></div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start gap-3 text-text-muted">
                  ...
                  <div>
                    ...
                    <span className="font-medium text-text-main">Chimalhuacán, Edomex</span>
                  </div>
                </li>
                ...
                <li className="flex items-start gap-3 text-text-muted">
                  ...
                  <div>
                    ...
                    <span className="font-medium text-text-main">Autodidacta / Téc. Informática</span>
                  </div>
                </li>
          ...
          <div className="lg:col-span-2">
            <div className="bg-surface-bg p-8 md:p-10 rounded-2xl border border-surface-border shadow-sm leading-relaxed text-lg text-text-muted space-y-6">
              <p>
                Soy <span className="font-bold text-text-main">Ivan Cruz</span>, tengo{" "}
                <span className="font-bold text-text-main">23 años</span> y soy de{" "}
                <span className="font-bold text-text-main">Chimalhuacán, Edomex, México</span>.
              ...
              <p>
                ...
                <span className="font-bold text-text-main">bases de la informática</span>.
                Sin embargo, la pandemia me llevó a dejar la universidad, lo que me impulsó
                hacia un <span className="font-bold text-text-main">aprendizaje autodidacta</span>.
              </p>

              <div>
                "Decidí inscribirme en cursos especializados en{" "}
                <span className="font-bold text-text-main not-italic">desarrollo frontend</span>{" "}
              ...
              <p>
                ...
                <span className="font-bold text-text-main">varios proyectos</span>, lo que me
                brindó <span className="font-bold text-text-main">valiosa experiencia</span> en el campo.
              </p>
