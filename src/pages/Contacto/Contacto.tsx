        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-surface-bg p-6 rounded-2xl border border-surface-border shadow-sm hover:shadow-md transition-shadow group">
              ...
              <h3 className="text-lg font-bold text-text-main mb-1">Correo Electrónico</h3>
              <p className="text-text-muted text-sm mb-4">Para consultas detalladas o colaboraciones formales.</p>
              <a
            ...
            <div className="bg-surface-bg p-6 rounded-2xl border border-surface-border shadow-sm hover:shadow-md transition-shadow group">
              ...
              <h3 className="text-lg font-bold text-text-main mb-1">WhatsApp / Teléfono</h3>
              <p className="text-text-muted text-sm mb-4">Respuesta rápida para consultas breves.</p>
              <a
            ...
            <div className="bg-surface-bg p-6 rounded-2xl border border-surface-border shadow-sm flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-text-muted text-sm">Chimalhuacán, Estado de México</p>
              </div>
            </div>
          </div>
              ...
              <form className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    <label htmlFor="name" className="text-sm font-semibold text-text-muted">Nombre</label>
                    <input
                      type="text"
                      id="name"
                  ...
                  {/* Email */}
                  <div className="space-y-2">
                    <label htmlFor="email" className="text-sm font-semibold text-text-muted">Email</label>
                    <input
                      type="email"
                      id="email"
                ...
                {/* Asunto */}
                <div className="space-y-2">
                  <label htmlFor="subject" className="text-sm font-semibold text-text-muted">Asunto</label>
                  <input
                    type="text"
                    id="subject"
                ...
                {/* Mensaje */}
                <div className="space-y-2">
                  <label htmlFor="message" className="text-sm font-semibold text-text-muted">Mensaje</label>
                  <textarea
                    id="message"
                    rows={5}
